...
def get_rates_fiat(codes_fiat):
    ...
    '([{"from": "USD","to": "KZT","rate": 449.836,"updatedAt": "2024-03-27 16:17:23"}], "")'
...
def _to_request_dict(codes_fiat):
    """
    >>> _to_request_dict(["USD", "EUR", "KZT", "RUB", "TRY", "RSD", "CAD", "CHF", "NZD", "JPY"])
...
if __name__ == '__main__':
    try:
        print(_to_request_dict(["EUR", "KZT", "RUB", "TRY", "RSD", "CAD", "CHF", "USD"]))
        print(_to_request_dict(["EUR", "KZT", "RUB", "TRY", "RSD", "CAD", "CHF"]))
